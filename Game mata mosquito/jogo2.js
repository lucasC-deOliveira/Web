...
var cronometro = setInterval(function(){
		...
		if(tempo<60){
			...
			console.log("tempo menor que 60:" + criaMosquitoTempo)}

			else if(tempo>=60){criaMosquitoTempo= Math.floor(((60 / tempo )+ 0.3) * 1000)
				console.log("tempo maior que 60:" + criaMosquitoTempo)}
